    ...
    <div class="layout-view">
      <div class="logo-container non-selectable no-pointer-events">
        <div class="logo" :style="position">
          <img src="~assets/quasar-logo.png" alt="Quasar logo">
...
export default class Index extends Vue {
  orienting = (window as any).DeviceOrientationEvent && !Platform.is.desktop
  rotating = (window as any).DeviceMotionEvent && !Platform.is.desktop
  moveX = 0
  moveY = 0
  rotateY = 0
  rotateX = 0
  ...
  rotate (evt: any) {
    if (evt.rotationRate &&
      ...
      const accelX: number = evt.acceleration.x || evt.accelerationIncludingGravity.x
      const accelY: number = evt.acceleration.y || evt.accelerationIncludingGravity.y
      const accelZ: number = evt.acceleration.z || evt.accelerationIncludingGravity.z - 9.81
